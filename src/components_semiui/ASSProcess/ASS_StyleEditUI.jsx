...
const Ass_StyleEditUI = () => {
  ...
  const handleStyleInformationChange = (value) => {
  ...
  return (
    <div>
      <Card
        ...
        title="ASS样式信息修改工具"
      >
        <Form labelCol={{ span: 10 }} labelPosition="inset" labelAlign="right">
          <Form.Input
            id="input-dir"
            field="inputDir"
            style={{ width: "95%" }}
            ...
            onChange={handleInputdirChange}
          />
          <FormChange field_name={"inputDir"} setInput={setInput_dir} />
          <Form.Input
            id="suffix"
            field="assSuffix"
            style={{ width: "95%" }}
          ...
          <Form.Input
            ...
            label="样式信息"
            trigger="blur"
            placeholder="请输入修改后的样式信息"
            onChange={handleStyleInformationChange}
          />
          <Row>
            <Button
              type="primary"
              ...
              onClick={() =>
                click(input_dir, suffix, stylename, styleinformation)
              }
            >
              确认
            </Button>
