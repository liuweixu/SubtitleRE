...
const cardStyle = {
  width: "95%",
  margin: "0 auto",
  backgroundColor: "rgba(var(--semi-white), 0.4)",
  backdropFilter: "blur(10px)",
};

const MKVExtractorUI = () => {
  const { click, onClear, inputText, progress_percent } = MKVExtractor();
  ...
  return (
    <div>
      <Card
        ...
        style={cardStyle}
        styles={{
          body: { padding: 10, overflow: "hidden" },
        }}
        title="MKV字幕提取"
      >
        <Form
        ...
        >
          ...
          />
          <FormChange field_name={"inputDir"} setInput={setInput} />
          <Form.Input
            id="output"
            field="outputDir"
            style={{ width: "95%" }}
          ...
          />
          <FormChange field_name={"outputDir"} setInput={setOutput} />
          <Form.Input
            id="track"
            field="track"
            style={{ width: "95%" }}
