...
const SRTASSConvertLayout = () => <SRTASSConvertUI />;
const AlignProcessLayout = () => <SRTAndASSAlignUI />;
const ASSProcessScaledEditLayout = () => <ScaleEditUI />;
const ASSProcessASSFontNameEditLayout = () => <ASSFontNameEditUI />;
const ASSProcessASS_StyleEditLayout = () => <ASS_StyleEditUI />;

const MKVExrtactorLayout = () => <MKVExtractorUI />;
const ASSExtractorLayout = () => <ASSExtractorUI />;
  ...
  const items = [
    ...
    },
    {
      ...
      children: [
        {
          key: "21",
          label: "ScaledBorderAndShadow处理",
          content: <ASSProcessScaledEditLayout />,
        },
        {
          key: "22",
          label: "ASS样式字体名称修改",
          content: <ASSProcessASSFontNameEditLayout />,
        },
        {
          key: "23",
          label: "ASS样式修改_基于输入样式",
          content: <ASSProcessASS_StyleEditLayout />,
        },
      ],
    },
    {
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout>
        ...
        <Footer style={{ textAlign: "center" }}>
          A tool about subtitle processing / 一个用于字幕处理的小工具 ©
